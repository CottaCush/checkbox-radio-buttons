 ...
 * KEYBOARD SUBMIT
 *
 * Disable or enable the browser's default behaviour of submitting a form when the enter key is pressed on any of it's children input elements.
 *
 * The plugin can be enabled/disabled in two forms:
 *  a. through the presence of a form's data attribute, with an optional value
 *  b. through the jQuery plugin interface $(form).keyboardSubmit(action);
 *
 */
